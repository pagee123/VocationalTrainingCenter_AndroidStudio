...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout constLayout = findViewById(R.id.constLayout);
        registerForContextMenu(constLayout);
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        if (v.getId() == R.id.constLayout) {
            if (menu.size() == 0) {
                getMenuInflater().inflate(R.menu.context_menu_constraint_layout, menu);
            }
        }
        else if (v.getId() == R.id.txtView) {
            getMenuInflater().inflate(R.menu.context_menu_text_view, menu);
        }
    }
