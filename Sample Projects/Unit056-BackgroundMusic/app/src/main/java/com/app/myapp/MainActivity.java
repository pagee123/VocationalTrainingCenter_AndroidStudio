...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtnSetRepeat = findViewById(R.id.btnSetRepeat);
        mBtnCancelRepeat = findViewById(R.id.btnCancelRepeat);
        mBtnGoto = findViewById(R.id.btnGoto);
        mBtnAddToMediaStore = findViewById(R.id.btnAddToMediaStore);
        mEdtGoto = findViewById(R.id.edtGoto);
    ...
    private View.OnClickListener btnAddToMediaStoreOnClick =
